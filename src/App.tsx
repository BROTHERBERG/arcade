...
const Reveal = ({ children, className = "", delay = 0, direction = "up", duration = 800 }) => {
  ...
  const getTransform = () => {
    if (isVisible) return "opacity-100 translate-x-0 translate-y-0 scale-100 filter-blur-0";
...
const Navbar = ({ openModal, onNavigateHome, onNavigateCabinet = null }) => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-md shadow-sm h-20' : 'bg-white h-24'}`}>
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 h-full flex justify-between items-center">
        ...
        <div className="flex items-center cursor-pointer group flex-shrink-0" onClick={handleLogoClick}>
          ...
          <div className="flex flex-col leading-none">
            <span className="text-2xl tracking-widest font-bold text-gray-800 group-hover:text-[#e89c4d] transition duration-300 font-montserrat">ARCADE</span>
            <span className="text-[11px] tracking-[0.3em] text-gray-500 uppercase -mt-0.5 font-montserrat">Orthodontie</span>
          </div>
        </div>
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden bg-white absolute w-full shadow-lg transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-96 border-t' : 'max-h-0'}`}>
...
const Hero = () => {
  ...
  const heroImages = ['/hero1.webp', '/hero2.jpg', '/hero3.webp', '/hero4.webp', '/hero5.jpg'];
          ...
          <div className="relative z-20 order-2 lg:order-1">
            <Reveal direction="left" duration={1000}>
              ...
              <p className="text-base md:text-lg text-gray-600 font-light max-w-md">
                Cabinet d'orthodontie ARCADE - Excellence et innovation au service de votre sourire
              </p>
            </Reveal>
            ...
            <Reveal delay={350} direction="up" duration={800}>
              <div className="flex items-center gap-2 mt-8">
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4].map((star) => (
                    <svg key={star} className="w-5 h-5 text-[#FBBC04]" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                  <svg className="w-5 h-5 text-[#FBBC04]" fill="currentColor" viewBox="0 0 20 20">
                    <defs>
                ...
                <span className="text-gray-700 font-semibold text-sm">4.6</span>
                <span className="text-gray-500 text-sm">(35 avis)</span>
            ...
            <Reveal delay={300} direction="zoom" duration={1200}>
              ...
              <div className="relative w-full aspect-[4/3] lg:aspect-square">
                ...
                <svg className="absolute inset-0 w-0 h-0">
                  <defs>
                    <clipPath id="organicBubble" clipPathUnits="objectBoundingBox">
                      <path d="M 0.1,0.05
                ...
                {/* Text bubbles overlaying the image */}
                <div className="absolute -left-4 top-8 bg-white px-5 py-2 rounded-full shadow-lg z-10 animate-float">
                  <span className="text-xs md:text-sm font-bold text-gray-800 font-montserrat uppercase tracking-wide">Orthodontie</span>
                </div>

                <div className="absolute right-4 top-1/3 bg-white px-5 py-2 rounded-full shadow-lg z-10 animate-float-delayed">
                  <span className="text-xs md:text-sm font-bold text-[#e89c4d] font-montserrat uppercase tracking-wide">Moderne</span>
                </div>

                <div className="absolute left-8 -bottom-4 bg-[#e89c4d] px-5 py-2 rounded-full shadow-lg z-10 animate-float">
                  <span className="text-xs md:text-sm font-bold text-white font-montserrat uppercase tracking-wide">Experts</span>
                </div>

                {/* Decorative floating elements */}
                <div className="absolute -bottom-12 -right-12 w-32 h-32 bg-[#e89c4d]/10 rounded-full blur-2xl animate-pulse" />
                <div className="absolute -top-8 -left-8 w-24 h-24 bg-orange-200/20 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }} />
              </div>
            </Reveal>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50/30 pt-24">
        ...
        <div className="relative bg-gradient-to-r from-[#e89c4d] to-[#f4a860] py-16 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">Notre cabinet</h1>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-16 grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center order-2 lg:order-1">
                ...
                <p className="text-gray-700 leading-relaxed text-justify">
                  Au sein de notre cabinet d'orthodontie, l'accueil et l'écoute des patients sont primordiaux. Vous serez reçu par une équipe chaleureuse et professionnelle, dédiée à vous accompagner tout au long de votre traitement bucco-dentaire. Nous sommes convaincus que chaque patient mérite une attention personnalisée et un cadre apaisant. C'est pourquoi nous veillons à instaurer une atmosphère sereine et un climat de confiance.
                </p>
              </div>
          ...
          <Reveal direction="up" delay={100}>
            <div className="bg-gradient-to-br from-orange-100 to-orange-50 rounded-3xl shadow-xl p-8 md:p-12 mb-16 flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-2/3">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Suivez vos rendez-vous avec Dentapoche!</h3>
          ...
          <div className="mb-16">
            <Reveal direction="down">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Nos valeurs</h2>
            </Reveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <Reveal direction="up" delay={100}>
                <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-orange-50 transition duration-300 border-2 border-[#e89c4d]/30 text-center">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden">
                    <img src="/icon-ponctualite.png" alt="Ponctualité" className="w-full h-full object-contain" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900">Ponctualité</h3>
                </div>
              </Reveal>
              ...
              <Reveal direction="up" delay={200}>
                <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-orange-50 transition duration-300 border-2 border-[#e89c4d]/30 text-center">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden">
                    <img src="/icon-clarte.png" alt="Clarté" className="w-full h-full object-contain" />
                  </div>
              ...
              <Reveal direction="up" delay={300}>
                <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-orange-50 transition duration-300 border-2 border-[#e89c4d]/30 text-center">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden">
                    <img src="/icon-accompagnment.png" alt="Accompagnement" className="w-full h-full object-contain" />
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              <Reveal direction="up" delay={400}>
                <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-orange-50 transition duration-300 border-2 border-[#e89c4d]/30 text-center">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden">
                    <img src="/icon-accompagnment.png" alt="Écoute" className="w-full h-full object-contain" />
                  </div>
              ...
              <Reveal direction="up" delay={500}>
                <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl hover:bg-orange-50 transition duration-300 border-2 border-[#e89c4d]/30 text-center">
                  <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 overflow-hidden">
                    <img src="/icon-professional.png" alt="Professionnalisme" className="w-full h-full object-contain" />
                  </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-white rounded-3xl shadow-xl p-8 md:p-12 mb-16">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <img src="/tech-a.webp" alt="Studio photo" className="rounded-2xl shadow-lg w-full h-48 object-cover" />
                  <img src="/tech-b.jpg" alt="Scanner 3D" className="rounded-2xl shadow-lg w-full h-48 object-cover" />
                </div>

                {/* Text side */}
                <div>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Nos technologies</h3>
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    Découvrez les technologies de notre cabinet en cliquant sur le bouton ci-dessous :
                  </p>
          ...
          <div className="mb-16">
            <Reveal direction="up">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Nos espaces</h2>
            </Reveal>
            <Reveal direction="up" delay={100}>
              <div className="bg-[#f5e6d3] rounded-3xl p-6 md:p-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  <div className="overflow-hidden rounded-2xl shadow-lg h-[280px] md:h-[350px]">
                    <img src="/cabinet-1.webp" alt="Salle d'attente" className="w-full h-full object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-2xl shadow-xl h-[320px] md:h-[400px]">
                    <img src="/cabinet-2.webp" alt="Accueil du cabinet" className="w-full h-full object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-2xl shadow-lg h-[280px] md:h-[350px]">
                    <img src="/cabinet-3.webp" alt="Espace de soins" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </Reveal>
    ...
    <section id="cabinet" className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <Reveal direction="up" duration={1000}>
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed font-light mb-12 font-montserrat">
              Nous vous souhaitons la bienvenue sur notre site internet où vous trouverez des informations relatives aux soins que nous proposons. Un cadre chaleureux dans lequel nous avons plaisir de vous accompagner et conseiller tout au long de votre traitement.
            </p>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 mb-24 mt-16">
          <Reveal direction="zoom">
            <h3 className="text-3xl font-medium text-center text-gray-900 mb-12 font-montserrat">Un espace dédié à votre confort</h3>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Reveal key={idx} delay={item.delay} direction="up" className="rounded-3xl overflow-hidden shadow-lg h-64 relative group cursor-pointer">
          ...
          <div className="bg-white rounded-[3rem] p-10 md:p-14 flex flex-col md:flex-row items-center shadow-xl border border-gray-100 relative overflow-hidden group">
            ...
            <div className="flex-grow text-center md:text-left z-10">
              ...
              <p className="text-gray-500 text-lg mb-8 max-w-xl font-montserrat">
                Facilitez le suivi de votre traitement orthodontique avec l'application Dentapoche! Retrouvez vos prochains RDV, vos documents et conseils.
              </p>
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center md:justify-start font-montserrat">
                ...
                >
                  <div className="flex flex-col items-start leading-none">
                    <span className="text-[0.65rem] uppercase text-gray-300">TÉLÉCHARGER SUR</span>
                ...
                >
                  <div className="flex flex-col items-start leading-none">
                    <span className="text-[0.65rem] uppercase text-gray-300">TÉLÉCHARGER DANS</span>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50/30 pt-24">
        ...
        <div className="bg-gradient-to-r from-[#e89c4d] to-[#f5b976] py-16 relative overflow-hidden">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <h1 className="text-5xl font-bold text-white mb-4">Dr Matthieu Hutin</h1>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 p-8 md:p-12 bg-gradient-to-br from-[#fae8d1] to-white">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 bg-white rounded-full shadow-xl p-3 border-4 border-[#e89c4d]">
                  <div className="text-center">
                    <div className="text-xs font-bold text-[#e89c4d] uppercase">Depuis</div>
              ...
              <div className="flex-grow text-center md:text-left">
                <h2 className="text-3xl font-bold text-[#e89c4d] mb-4">Orthodontiste</h2>
                <div className="space-y-3 text-gray-700">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#e89c4d] rounded-full mt-2 flex-shrink-0" />
                    <p className="text-base">Diplôme d'études spécialisées en orthopédie Dento-Faciale, Nancy</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#e89c4d] rounded-full mt-2 flex-shrink-0" />
                    <p className="text-base">Diplôme de chirurgie dentaire, Lille</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 md:p-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed text-base">
                  Il choisi cette spécialité car il est attiré par l'esthétique et l'opportunité de rendre le sourire à ses patients. Après avoir travaillé dans des cabinets d'orthodontie en métropole, il décide de s'installer à la Réunion en 2019.
                </p>
                <p className="text-gray-700 leading-relaxed text-base mt-6">
                  Le Dr. Hutin a une approche minutieuse et accorde une grande importance à ce que ses patients comprennent pleinement les traitements engagés. Il est également conscient de la bienveillance envers ses patients et valorise la ponctualité et l'organisation de son cabinet.
                </p>
                <p className="text-gray-700 leading-relaxed text-base mt-6">
                  Passionné par les nouvelles technologies, il les intègre dans sa pratique quotidienne. En dehors de son travail, le Dr. Hutin aime les sports en plein air, la cuisine et la culture pop.
                </p>
              </div>
            </div>
...
const Team = ({ onShowDoctorProfile }) => {
  return (
    <section id="equipe" className="py-24 bg-white relative overflow-visible">
        ...
        <div className="absolute -left-32 top-1/4 w-[600px] h-[600px] bg-gradient-to-br from-[#e89c4d]/40 via-[#f5b976]/30 to-[#fcd9b8]/20 rounded-full blur-[100px] animate-pulse" style={{ zIndex: 0 }} />
          ...
          <div className="flex flex-col items-center mb-24 relative">
            <Reveal direction="left">
              <h3 className="text-3xl font-light text-gray-800 mb-12 flex items-center font-montserrat">
                <span className="w-12 h-[1px] bg-[#e89c4d] mr-4" />Les orthodontistes<span className="w-12 h-[1px] bg-[#e89c4d] ml-4" />
              </h3>
            </Reveal>
            <Reveal direction="zoom" delay={200} className="group relative">
              ...
              >
                <img src="/matthieu-1.jpg" alt="Dr Matthieu Hutin" className="w-full h-full object-cover object-top absolute inset-0 group-hover:opacity-0 transition-opacity duration-200" />
                <img src="/matthieu-2.jpg" alt="Dr Matthieu Hutin" className="w-full h-full object-cover object-top absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
              ...
              <div className="text-center mt-8 font-montserrat">
                <h4 className="text-2xl font-bold text-gray-900">Dr Matthieu Hutin</h4>
                <p className="text-base text-gray-500 mt-2 max-w-xs mx-auto font-medium">Orthodontiste, spécialiste qualifié en orthopédie dento-faciale</p>
              </div>
            </Reveal>
          </div>
        ...
        <div className="text-center">
          <Reveal direction="right">
            <h3 className="text-3xl font-light text-gray-800 mb-16 flex items-center justify-center font-montserrat">
              <span className="w-12 h-[1px] bg-[#e89c4d] mr-4" />Et nos assistantes dentaires qualifiées<span className="w-12 h-[1px] bg-[#e89c4d] ml-4" />
            </h3>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 max-w-6xl mx-auto">
            {[
              { name: "Ketty", role: "Assistante dentaire", img1: "/ketty-1.jpg", img2: "/ketty-2.jpg", delay: 0 },
              { name: "Sarah", role: "Assistante dentaire", img1: "/sarah-1.jpg", img2: "/sarah-2.jpg", delay: 200 },
              { name: "Régine", role: "Secrétaire", img1: "/regine-1.jpg", img2: "/regine-2.jpg", delay: 400 }
            ].map((member, idx) => (
              <Reveal key={idx} delay={member.delay} direction="up" className="flex flex-col items-center group font-montserrat">
                <div className="w-64 h-64 bg-[#fae8d1] rounded-[2rem] overflow-hidden shadow-lg transform transition duration-300 group-hover:scale-105 border-4 border-white ring-1 ring-gray-100 relative">
                  <img src={member.img1} alt={member.name} className="w-full h-full object-cover object-top absolute inset-0 group-hover:opacity-0 transition-opacity duration-200" />
                  <img src={member.img2} alt={member.name} className="w-full h-full object-cover object-top absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                </div>
                <h4 className="text-xl font-bold text-gray-900 mt-6 group-hover:text-[#e89c4d] transition">{member.name}</h4>
  ...
  return (
    <div className="font-montserrat">
      ...
      <div className="min-h-screen bg-white pt-24">
        ...
        <div className="bg-gradient-to-r from-[#e89c4d] to-[#f5b976] py-16 relative overflow-hidden">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <h1 className="text-5xl font-bold text-white mb-4">{appareil.title}</h1>
            <p className="text-white/80 text-sm">Accueil / Appareils / {appareil.title}</p>
          </div>
...
const appareilsData = [
  {
    ...
    subtitle: "Qu'est-ce que l'orthodontie interceptive ou interception orthodontique ?",
    ...
    sections: [
      {
        ...
        content: [
          "Les orthodontistes préconisent le traitement d'interception orthodontique chez les jeunes patients qui ont encore des dents de lait. Ce traitement est recommandé lorsque l'enfant présente divers problèmes dentaires comme la succion du pouce, un déséquilibre de largeur entre les mâchoires, ou un espace insuffisant pour l'évolution des dents définitives."
        ]
      }
    ]
  },
  {
    ...
    subtitle: "Appareil d'orthodontie visible métal : une solution efficace pour votre traitement",
  ...
  },
  {
    ...
    subtitle: "Orthodontie discrète : multi-attaches céramique et métal : une solution discrète et efficace",
  ...
  },
  {
    ...
    subtitle: "Le traitement d'orthodontie invisible par aligneurs ou gouttières",
    ...
    <section id="appareils" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#e8e8e8] rounded-[3rem] p-8 md:p-12 lg:p-16">
          <Reveal direction="down">
            <h2 className="text-4xl font-medium text-center text-gray-900 mb-16 font-montserrat">Appareils</h2>
          </Reveal>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 font-montserrat">
          {[
            { title: "Orthodontie interceptive", img: "/orthodontie-interceptive.webp", delay: 100, id: 'interceptive' },
            { title: "Orthodontie visible", img: "/orthodontie-visible.webp", delay: 250, id: 'visible' },
            { title: "Orthodontie discrète", img: "/Orthodontie-discrete.webp", delay: 400, id: 'discrete' },
            { title: "Orthodontie Invisible", img: "/orthodontie-invisible.webp", delay: 550, id: 'invisible' }
          ].map((item, idx) => (
            <Reveal key={idx} delay={item.delay} direction="up">
              <div
                ...
                <div className="p-8 flex-grow flex items-center justify-center bg-white relative h-64">
                  ...
                  <img src={item.img} alt={item.title} className="w-full h-full object-contain rounded-xl transform group-hover:scale-110 transition duration-500 relative z-10" />
                </div>
        ...
        <Reveal direction="zoom" duration={1000}>
          <div className="relative w-full rounded-[3rem] overflow-hidden shadow-2xl h-[400px] md:h-[350px]">
            ...
            <div className="relative z-40 p-10 md:p-16 h-full flex flex-col justify-center max-w-xl">
              <h3 className="text-4xl font-bold text-white mb-4 font-montserrat">Contention</h3>
...
const Traitements = () => {
  const treatments = [
    { title: "Traitement fonctionnel", desc: "Le traitement fonctionnel est une méthode qui vise à corriger les dysfonctions comme la succion du pouce ou les troubles de la déglutition.", img: "/traitment-functionel.jpg" },
    { title: "Traitement orthopédique", desc: "Le traitement orthopédique utilise des appareils pour corriger les anomalies de croissance des os de la mâchoire chez les enfants et les adolescents. Ce traitement cible la structure osseuse elle-même, cherchant à modifier la croissance faciale pour atteindre un équilibre harmonieux entre les mâchoires et le visage.", img: "/traitment-ortho-1.jpg" },
    { title: "Traitement orthodontique", desc: "Le traitement orthodontique est principalement focalisé sur le déplacement des dents à l'intérieur de l'arcade dentaire pour obtenir un alignement optimal et une occlusion fonctionnelle.", img: "/traitment-ortho-2.jpg" },
    { title: "Traitement adulte", desc: "L'orthodontie adulte a pour but de corriger les anomalies liées à la dentition chez les adultes. Il est possible d'utiliser tous les appareils d'orthodontie chez les adultes, ceux-ci font plus souvent le choix d'un appareil discret.", img: "/traitment-adulte.jpg" },
    { title: "Chirurgie maxillo-faciale", desc: "Les traitements orthodontiques qui impliquent la chirurgie maxillo-faciale sont utilisés pour corriger les anomalies sévères des mâchoires qui ne peuvent être résolues par des appareils orthodontiques seuls. Ce type de traitement est souvent indiqué pour les décalages squelettiques importants.", img: "/traitment-chirurgie.jpg" }
  ];
    ...
    <section id="traitements" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <Reveal direction="up" duration={800}>
            <div className="bg-white rounded-[2rem] p-12 flex flex-col justify-center border border-[#e89c4d]/20 aspect-square md:aspect-auto md:h-full font-montserrat" style={{ boxShadow: '8px 8px 0px 0px #e89c4d' }}>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Nos traitements</h2>
              <p className="text-gray-500 max-w-sm leading-relaxed">Des solutions adaptées à chaque âge et chaque besoin pour un sourire harmonieux.</p>
            </div>
          </Reveal>
          ...
          <Reveal direction="up" delay={100} duration={800}>
            <div className="relative rounded-[2rem] overflow-hidden group cursor-pointer aspect-square">
              <img src={treatments[0].img} alt={treatments[0].title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              {/* Default: title pill */}
              <div className="absolute top-5 left-5 z-20 transition-opacity duration-300 group-hover:opacity-0">
                <div className="bg-white/95 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm">
                  <span className="text-gray-900 font-semibold text-sm font-montserrat">{treatments[0].title}</span>
                </div>
              </div>
              ...
              <div className="absolute inset-0 bg-[#e89c4d]/85 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 z-10">
                <h4 className="text-white text-xl font-bold mb-3 font-montserrat">{treatments[0].title}</h4>
                <p className="text-white/90 text-sm leading-relaxed font-montserrat">{treatments[0].desc}</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal direction="up" delay={150} duration={800}>
            <div className="relative rounded-[2rem] overflow-hidden group cursor-pointer aspect-square">
              <img src={treatments[1].img} alt={treatments[1].title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              <div className="absolute top-5 left-5 z-20 transition-opacity duration-300 group-hover:opacity-0">
                <div className="bg-white/95 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm">
                  <span className="text-gray-900 font-semibold text-sm font-montserrat">{treatments[1].title}</span>
                </div>
              </div>
              <div className="absolute inset-0 bg-[#e89c4d]/85 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 z-10">
                <h4 className="text-white text-xl font-bold mb-3 font-montserrat">{treatments[1].title}</h4>
                <p className="text-white/90 text-sm leading-relaxed font-montserrat">{treatments[1].desc}</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal direction="up" delay={200} duration={800}>
            <div className="relative rounded-[2rem] overflow-hidden group cursor-pointer aspect-square">
              <img src={treatments[2].img} alt={treatments[2].title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              <div className="absolute top-5 left-5 z-20 transition-opacity duration-300 group-hover:opacity-0">
                <div className="bg-white/95 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm">
                  <span className="text-gray-900 font-semibold text-sm font-montserrat">{treatments[2].title}</span>
                </div>
              </div>
              <div className="absolute inset-0 bg-[#e89c4d]/85 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 z-10">
                <h4 className="text-white text-xl font-bold mb-3 font-montserrat">{treatments[2].title}</h4>
                <p className="text-white/90 text-sm leading-relaxed font-montserrat">{treatments[2].desc}</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal direction="up" delay={250} duration={800}>
            <div className="relative rounded-[2rem] overflow-hidden group cursor-pointer aspect-square">
              <img src={treatments[3].img} alt={treatments[3].title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              <div className="absolute top-5 left-5 z-20 transition-opacity duration-300 group-hover:opacity-0">
                <div className="bg-white/95 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm">
                  <span className="text-gray-900 font-semibold text-sm font-montserrat">{treatments[3].title}</span>
                </div>
              </div>
              <div className="absolute inset-0 bg-[#e89c4d]/85 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 z-10">
                <h4 className="text-white text-xl font-bold mb-3 font-montserrat">{treatments[3].title}</h4>
                <p className="text-white/90 text-sm leading-relaxed font-montserrat">{treatments[3].desc}</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal direction="up" delay={300} duration={800}>
            <div className="relative rounded-[2rem] overflow-hidden group cursor-pointer aspect-square">
              <img src={treatments[4].img} alt={treatments[4].title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
              <div className="absolute top-5 left-5 z-20 transition-opacity duration-300 group-hover:opacity-0">
                <div className="bg-white/95 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-sm">
                  <span className="text-gray-900 font-semibold text-sm font-montserrat">{treatments[4].title}</span>
                </div>
              </div>
              <div className="absolute inset-0 bg-[#e89c4d]/85 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 z-10">
                <h4 className="text-white text-xl font-bold mb-3 font-montserrat">{treatments[4].title}</h4>
                <p className="text-white/90 text-sm leading-relaxed font-montserrat">{treatments[4].desc}</p>
              </div>
            </div>
          </Reveal>
        </div>
                ...
                >
                  <div className="flex items-center gap-5 p-6">
                    <div className={`w-16 h-16 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors ${
                      ...
                      <item.icon size={28} className={`transition-colors ${isOpen ? 'text-[#e89c4d]' : 'text-gray-400'}`} strokeWidth={1.5} />
                    </div>
                    <h3 className={`text-lg md:text-xl font-bold flex-grow transition-colors ${isOpen ? 'text-gray-900' : 'text-gray-700'}`}>
                      {item.title}
                    </h3>
                    <ChevronDown size={22} className={`text-gray-400 transition-transform duration-300 flex-shrink-0 ${isOpen ? 'rotate-180' : ''}`} />
                  </div>

                  <div className={`transition-all duration-300 ease-out overflow-hidden ${isOpen ? 'max-h-48 pb-6' : 'max-h-0'}`}>
...
const conseilsData = [
  {
    ...
    videoId: 'feyaEbdJgIU',
    sections: [
      { heading: "Comment bien brosser vos dents avec un appareil d'orthodontie ?", body: "Le brossage des dents avec un appareil multiattaches (bagues) nécessite une attention particulière pour maintenir une bonne hygiène bucco-dentaire. Les bagues, les fils et les élastiques retiennent facilement la plaque dentaire et les débris alimentaires. Il est donc essentiel de bien nettoyer vos dents et votre appareil pour éviter les caries, les inflammations des gencives ou d'autres problèmes bucco-dentaires." },
      { heading: "Utilisez la bonne brosse à dents", body: "Choisissez une brosse à dents à poils souples, ou une brosse à dents électrique à poils souples. Les poils souples aident à nettoyer autour des brackets sans endommager les gencives. Il existe également des brosses interdentaires, idéales pour atteindre les zones entre les brackets et le fil." },
      { heading: "Technique de brossage recommandée", body: "Brossez vous les dents pendant 2min minimum ! Faites des mouvements circulaires doux en passant par la gencive et les dents, en prenant soin de nettoyer au-dessus et au-dessous des brackets. Brossez chaque dent individuellement et passez du temps sur les zones les plus difficiles d'accès. N'oubliez pas de brosser la surface intérieure des dents." },
      { heading: "Minimum 2 fois par jours : matin et soir", body: "Avec un appareil multiattaches, il est préférable de vous brosser les dents après chaque repas donc 3 fois par jours. Cela évite que les aliments ne restent coincés dans votre appareil. Le minimum reste un brossage le matin, après le petit-déjeuner et le soir, après le repas." },
      { heading: "Utilisez un révélateur de plaque ou un dentifrice éducatif pour évaluer votre brossage", body: "L'utilisation d'un révélateur de plaque ou d'un dentifrice éducatif est un excellent moyen d'auto-évaluer l'efficacité de votre brossage. Ces produits colorent la plaque dentaire en rose ou en bleu, vous montrant les zones où le brossage est insuffisant. Vous pouvez utiliser le révélateur après le brossage pour vérifier si des résidus persistent autour des bagues, des fils ou des espaces entre les dents. Cela vous permet de mieux cibler les zones à améliorer et de perfectionner votre technique de brossage." },
    ],
  ...
  },
  {
    ...
    videoId: null,
    intro: "Entretenir son appareil orthodontique est indispensable pour assurer son efficacité et préserver une bonne santé bucco-dentaire. Un dispositif négligé peut causer des soucis comme des caries, des affections des gencives, voire altérer l'alignement dentaire. Heureusement, quelques démarches simples peuvent avoir un impact significatif.",
    sections: [
      { heading: "Hygiène quotidienne : impératif incontournable", body: "Tout d'abord, il est essentiel de nettoyer l'appareil orthodontique quotidiennement. Utilisez une brosse à poils doux pour nettoyer délicatement autour des attaches et des fils. Ensuite, brossez-vous les dents après chaque repas pour éviter l'accumulation de plaque et de résidus alimentaires. Par ailleurs, l'utilisation de fil dentaire ou de brossettes interdentaires peut faciliter l'accès aux zones difficiles entre les dents et l'appareillage." },
      { heading: "Conseils spécifiques pour l'entretien des multi-attaches et des aligneurs transparents", body: "Pour les personnes portant des multi-attaches, il est crucial de vérifier régulièrement l'intégrité des attaches pour s'assurer qu'aucune n'est desserrée ou endommagée. De plus, l'application de cire orthodontique peut soulager les irritations causées par les attaches.\n\nEn ce qui concerne les aligneurs transparents, ils doivent être nettoyés séparément avec un produit spécifique pour éviter la décoloration et l'accumulation de bactéries. Respectez les instructions de votre orthodontiste pour leur remplacement afin de garantir un alignement progressif et efficace des dents." },
      { heading: "Rendez-vous réguliers chez le spécialiste orthodontiste : suivi indispensable", body: "Enfin, n'oubliez pas vos consultations chez l'orthodontiste. Ces visites sont essentielles pour ajuster votre dispositif et s'assurer de son bon fonctionnement. De plus, votre orthodontiste peut vous fournir des conseils personnalisés et répondre à vos questions spécifiques. Ainsi, une communication régulière avec votre praticien est cruciale pour assurer le meilleur soin possible de votre appareil dentaire." },
      { heading: "Investir dans votre santé bucco-dentaire", body: "Investir du temps et de l'attention dans l'entretien de votre appareil orthodontique peut sembler fastidieux, mais les avantages à long terme en valent largement la peine. En prenant soin de votre appareil, vous investissez également dans votre santé bucco-dentaire globale. Des dents bien alignées et une bouche saine peuvent non seulement améliorer votre estime de soi, mais aussi prévenir des problèmes plus graves à l'avenir." },
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50/30 pt-24">
        ...
        <div className="max-w-3xl mx-auto px-4 py-16 relative">
          ...
          <div className="relative z-10">
            ...
            {conseil.intro && (
              <p className="text-gray-600 text-base leading-relaxed mb-10">{conseil.intro}</p>
            )}
            ...
            <div className="space-y-10">
              {conseil.sections.map((section, idx) => (
                <div key={idx}>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">{section.heading}</h3>
                  <div className="border-t border-gray-200 pt-4">
                    {section.body.split('\n\n').map((paragraph, pIdx) => (
                      <p key={pIdx} className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">{paragraph}</p>
                    ))}
                  </div>
                </div>
              ))}
            ...
            {/* Outro if present */}
            {conseil.outro && (
              <p className="text-gray-600 text-base leading-relaxed mt-10">{conseil.outro}</p>
            )}
            ...
            {conseil.relatedText && (
              <p className="text-gray-500 text-sm mt-10">
                À découvrir également : {' '}
                <button onClick={() => onNavigateConseil(conseil.relatedId)} className="text-[#e89c4d] font-semibold hover:underline">
                  {conseil.relatedText}
                </button>
                {' '} au{' '}
                <button onClick={onClose} className="text-[#e89c4d] font-semibold hover:underline">
...
const ConseilsSection = ({ onShowIncidents, onShowConseil }) => {
  ...
  const conseils = [
    { id: "hygiene", title: "Hygiène bucco-dentaire avec un appareil d'orthodontie", img: "/counseils-1.webp" },
    { id: "soin-appareil", title: "Prendre soin de son appareil orthodontique", img: "/counseils-2.webp" },
    { id: "reussir-traitement", title: "Comment réussir son traitement d'orthodontie ?", img: "/counseils-3.webp" },
  ];
  ...
  const nextSlide = () => setCarouselIndex((prev) => (prev + 1) % conseils.length);
  const prevSlide = () => setCarouselIndex((prev) => (prev - 1 + conseils.length) % conseils.length);
  ...
  return (
    <section className="py-24 bg-[#2a2a2a] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Reveal direction="up" duration={800}>
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-28">
            ...
            <div className="w-full lg:w-2/5 font-montserrat">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">Les incidents en orthodontie</h2>
              <p className="text-gray-400 text-base leading-relaxed mb-8">
                Découvrez les incidents en orthodontie de notre cabinet en cliquant sur le bouton ci-dessous :
              </p>
              <button onClick={onShowIncidents} className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full text-xs font-bold tracking-widest hover:bg-white hover:text-[#2a2a2a] transition duration-300 font-montserrat">
                DÉCOUVRIR
              </button>
            </div>
            ...
            <div className="w-full lg:w-3/5 relative h-[380px] md:h-[440px]">
              ...
              <div className="absolute left-[0%] top-[12%] w-[42%] h-[78%] rounded-2xl overflow-hidden shadow-2xl z-10 border-2 border-white/10">
              ...
              <div className="absolute right-[0%] top-[20%] w-[42%] h-[78%] rounded-2xl overflow-hidden shadow-2xl z-30 border-2 border-white/10">
        ...
        <div className="relative mb-16">
          <svg viewBox="0 0 1200 60" className="w-full h-12 text-[#e89c4d]" preserveAspectRatio="none">
            <path d="M0,30 Q300,0 600,30 T1200,30" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.4" />
          </svg>
        </div>
        ...
        <div className="mb-16">
          <Reveal direction="up">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white font-montserrat mb-4 sm:mb-0">Conseils & Honoraires</h2>
              <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full text-xs font-bold tracking-widest hover:bg-white hover:text-[#2a2a2a] transition duration-300 font-montserrat">
                DÉCOUVRIR
              </button>
            </div>
          </Reveal>
            ...
            <div className="relative">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {conseils.map((item, idx) => (
                  <div key={idx} onClick={() => onShowConseil(item.id)} className="group relative rounded-2xl overflow-hidden h-[280px] cursor-pointer border border-[#e89c4d]/20 hover:border-[#e89c4d]/50 transition-all duration-500">
                    <img src={item.img} alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                    <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                      <p className="text-white font-semibold text-sm leading-snug font-montserrat">{item.title}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <Reveal direction="up" delay={200}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {videos.map((video, idx) => (
              <div key={idx} onClick={() => openVideoModal(video.url)} className="group cursor-pointer">
                <div className="relative rounded-xl overflow-hidden mb-3 aspect-video border border-white/10 group-hover:border-[#e89c4d]/40 transition">
                  <img src={video.thumbnail} alt={video.title} className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition" />
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="w-14 h-14 rounded-full bg-white/90 flex items-center justify-center group-hover:bg-[#e89c4d] group-hover:scale-110 transition-all duration-300 shadow-lg">
                      <Play size={20} className="text-gray-800 group-hover:text-white ml-1" fill="currentColor" />
                    </div>
                  </div>
                </div>
                <p className="text-white text-sm font-medium font-montserrat leading-snug group-hover:text-[#e89c4d] transition">{video.title}</p>
              </div>
            ))}
          </div>
        </Reveal>
        ...
        {/* Video Modal */}
        {videoModalOpen && (
          <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/90 backdrop-blur-sm" onClick={closeVideoModal}>
  ...
  const technologies = [
    {
      ...
      description: "La radio panoramique est une technologie permettant l'exploration précise des structures osseuses et dentaires en trois dimensions. Une technologie essentielle dans l'élaboration d'un plan de traitement et pour le suivi de chaque patient.",
      image: "/tech-b.jpg",
      bgColor: "bg-gray-100"
    },
    {
      title: "Empreinte optique",
      description: "L'empreinte optique numérique est une technologie de pointe qui permet l'obtention d'image en direct d'une ou de plusieurs dents en trois dimensions et à l'aide d'une caméra intra-buccale couplée à un ordinateur.",
      image: "/tech-c.webp",
      bgColor: "bg-orange-100"
    },
    {
      title: "Communication",
      description: "Facilitez le suivi de votre traitement orthodontique avec l'application Dentapoche!",
      image: "/tech-d.webp",
      bgColor: "bg-gray-100",
      hasAppButtons: true
    },
    {
      title: "Studio photo",
      description: "La photographie numérique est une aide essentielle dans le recueil de données, le diagnostic et la transmission d'informations. Un outil incontournable en dentisterie et garant d'un bon suivi thérapeutique pour chaque patient.",
      image: "/tech-a.webp",
      bgColor: "bg-orange-100"
    },
    {
      title: "Stérilisation",
      description: "La sécurité et le confort de chaque patient et de chaque membre de l'équipe est une priorité au sein du cabinet, qui applique avec rigueur une procédure de stockage des instruments à l'abri de toute contamination pour garantir une hygiène parfaite entre chaque visite.",
      image: "/tech-f.webp",
      bgColor: "bg-gray-100"
    }
  ];
    ...
    <div className="font-montserrat">
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50/30 pt-24">
        ...
        <div className="relative bg-gradient-to-r from-[#e89c4d] to-[#f4a860] py-16 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">Nos technologies</h1>
            <div className="flex items-center gap-2 text-white/80 text-sm">
              <button onClick={onClose} className="hover:text-white transition">Accueil</button>
              <span>/</span>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 space-y-8">
          {technologies.map((tech, index) => {
            ...
            return (
              <Reveal key={index} direction={isEven ? "left" : "right"} delay={index * 100}>
                <div className={`${tech.bgColor} rounded-3xl overflow-hidden shadow-lg flex flex-col ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  {/* Image side */}
                  ...
                  <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{tech.title}</h3>
                    <p className="text-gray-700 leading-relaxed text-justify">
                      {tech.description}
                    </p>
...
const Technologies = ({ onShowTechnologies }) => {
  return (
    <section id="technologies" className="py-12 relative overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal direction="up">
...
const FAQ = () => {
  ...
  const items = [
    { q: "À quel âge doit-on consulter ?", a: "La première consultation est recommandée vers l'âge de 7 ans. À cet âge, les premières molaires définitives sont sorties et nous pouvons détecter d'éventuels problèmes de croissance ou de positionnement dentaire." },
    { q: "Est-ce que le traitement est douloureux ?", a: "Avec les techniques modernes, l'inconfort est minime. Une légère sensibilité peut être ressentie pendant les 2-3 jours suivant la pose ou l'activation de l'appareil, mais elle s'estompe rapidement." },
    { q: "Combien de temps dure un traitement ?", a: "La durée varie selon la complexité du cas, généralement entre 6 mois et 2 ans. Un devis précis et une estimation de durée vous seront remis lors du bilan." }
  ];
  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4">
        <Reveal direction="down">
          <h2 className="text-4xl font-medium text-center text-gray-900 mb-16 font-montserrat">Vos questions fréquentes</h2>
        </Reveal>
        <div className="space-y-4 font-montserrat">
          {items.map((item, idx) => (
            <Reveal key={idx} direction="up" delay={idx * 100}>
              <div className="border border-gray-200 rounded-2xl overflow-hidden cursor-pointer" onClick={() => setOpenIndex(openIndex === idx ? null : idx)}>
                <div className="bg-gray-50 p-6 flex justify-between items-center hover:bg-gray-100 transition">
                  ...
                  <ChevronDown className={`text-[#e89c4d] transition-transform duration-300 ${openIndex === idx ? 'rotate-180' : ''}`} />
                </div>
                <div className={`transition-all duration-300 ease-out overflow-hidden bg-white px-6 ${openIndex === idx ? 'max-h-40 py-6' : 'max-h-0 py-0'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-16 relative z-10">
        <div>
          <div className="flex items-center mb-8">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] tracking-[0.3em] uppercase opacity-70">Orthodontie</span>
            </div>
          </div>
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            Cabinet d'Orthodontie Dr Matthieu Hutin.<br />
            Spécialiste qualifié en orthopédie<br />dento-faciale.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4 text-sm text-gray-400">
            <p className="flex items-start hover:text-white transition cursor-pointer" onClick={() => document.getElementById('acces').scrollIntoView({behavior: 'smooth'})}>
              <MapPin size={18} className="mr-3 text-[#e89c4d]" />
              <span>69 Rue Alexis de Villeneuve<br />97400 Saint-Denis</span>
            </p>
...
const Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 font-montserrat">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden" style={{ animation: 'modalIn 0.4s cubic-bezier(0.16, 1, 0.3, 1)' }}>
        {/* Orange header band */}
        ...
        <div className="relative -mt-6 bg-white rounded-t-3xl px-8 pt-8 pb-6">
          ...
          <p className="text-gray-600 text-sm leading-relaxed mb-6">
            Pour prendre rendez-vous, veuillez nous contacter par téléphone ou utilisez l'application <strong className="text-gray-900">Dentapoche</strong> si vous êtes déjà patient.
          </p>
          ...
          >
            ...
            <div>
              <span className="text-xs text-white/60 uppercase tracking-wider">Appeler le cabinet</span>
          ...
          >
            ...
            <div>
              <span className="text-xs text-gray-400 uppercase tracking-wider">Déjà patient ?</span>
...
export default function App() {
  ...
  const [currentPage, setCurrentPage] = useState<'home' | 'doctor' | 'cabinet' | string>('home');
  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-sans selection:bg-[#e89c4d] selection:text-white font-montserrat">
      ...
      <Navbar openModal={() => setModalOpen(true)} onNavigateHome={goHome} onNavigateCabinet={() => navigateToPage('cabinet')} />
      <FAB openModal={() => setModalOpen(true)} />
      ...
      <main>
        ...
        <Appareils onSelectAppareil={(id) => navigateToPage(`appareil-${id}`)} />
        <Parcours />
        <Traitements />
        <ConseilsSection onShowIncidents={() => navigateToPage('incidents')} onShowConseil={(id) => navigateToPage(`conseil-${id}`)} />
